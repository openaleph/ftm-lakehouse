...
class DatasetLakeArchive(LakeMixin):
    ...
    def open_file(self, file: File) -> ContextManager[BytesIO]:
    ...
    def archive_file(
        ...
        **data,
        ...
        file.raw = dict_merge(file.raw, data)
    ...
    def delete_file(self, file: File) -> None:
        ...
        # FIXME delete file entities from statements
